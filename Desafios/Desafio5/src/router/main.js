...
// function routerMain(app, express){
...
//     app.engine("hbs", hbs.engine); // Inicializamos el motor con app.engine, para indicar que motor usaremos. En este caso, handlebars.engine
...
//     app.use("/", function(req, res){res.render("index", {name: "German"})});
